...
def main():
    ...
    parser.add_argument("--out_task", default=r"examples/expert_traj/expert1_task.json", help="输出 task.json 路径")
    parser.add_argument("--out_layout", default=r"examples/expert_traj/expert1_layout.json")
    ...
    parser.add_argument(
        "kicad_pcb",
        nargs="?",
        default=r"examples/tasks/anavi-thermometer.kicad_pcb",

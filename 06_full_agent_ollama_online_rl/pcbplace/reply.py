...
def run_reply(
    ...
    *,
    ...
    Accepted payload fields:
      ...
      - fixed_refs / locked_refs: optional exact or glob-like refs to lock at
        current/fixed positions before inference
    ...
    fixed_refs = _coerce_ref_list(payload.get("fixed_refs") or payload.get("locked_refs"))

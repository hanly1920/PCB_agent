...
def _add_placement_env_args(ap: argparse.ArgumentParser) -> None:
    ...
    The scan/simulation now measures the same mask/objective behavior that
    training sees when spacing, density, module-region, and edge-clearance
    knobs are changed.
    """
...
def main():
    ...
    print(f"[env] scan uses PlacementEnv kwargs: {env_kwargs}")

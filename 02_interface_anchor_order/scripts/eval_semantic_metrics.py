...
def main() -> None:
    ...
    ap.add_argument("--zone_edge_ratio", type=float, default=0.12)
    ap.add_argument("--zone_core_ratio", type=float, default=0.28)
    args = ap.parse_args()
    ...
    for task_path in task_paths:
        ...
        per_task.append(
            evaluate_task_file(
                task_path,
                pred_path=pred_path,
                zone_edge_ratio=args.zone_edge_ratio,
                zone_core_ratio=args.zone_core_ratio,
            )
        )
